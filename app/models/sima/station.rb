module Sima
  class Station
    ...
    NAME_NORMALIZATION_MAP_B = {
      ...
      "[2] San Nicolás"    => "Noreste San Nicolas",
    ...
    def self.from_type_a_data(data, general_attributes = {})
    ...
    protected
      ...
      def self.normalize_name_type_a(given_name)
      ...
      def self.normalize_name_type_b(given_name)
